    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">Create Entity</h1>
                    <p class="text-xs text-gray-500 mt-0.5">Fill in the entity details</p>
                </div>
                ...
                <form action="{{ route('entities.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="flex gap-4 mt-1">
                                ...
                                <label class="flex items-center gap-1 text-sm">
                                    <input type="checkbox" name="types[]" value="{{ $typeOption->id }}"
                                        {{ old('types') && in_array($typeOption->id, old('types')) ? 'checked' : '' }}
                        ...
                        <div class="sm:col-span-2 flex items-center gap-2 mt-2">
                            <input type="checkbox" name="rgpd_consent" id="rgpd_consent" value="1" {{ old('rgpd_consent') ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
