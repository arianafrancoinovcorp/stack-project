    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">Create Item</h1>
                    <p class="text-xs text-gray-500 mt-0.5">Add a new item to the system</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="mt-1 block w-full rounded border-gray-300 shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="vat_id" id="vat_id"
                                ...
                                @foreach($vats as $vat)
                                    <option value="{{ $vat->id }}" {{ old('vat_id') == $vat->id ? 'selected' : '' }}>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                      class="mt-1 block w-full rounded border-gray-300 shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">{{ old('notes') }}</textarea>
                        </div>
